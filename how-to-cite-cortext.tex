...
\printbibliography[type=software,keyword=cortext-bibtex,title={\small References (example)}]
...
\section{Cite CorTexT Manager with APA} \label{example-apa}

APA style or APA format is a writing style and format described in the style
guide of the American Psychological Association (APA)\footnote{\url{https://en.wikipedia.org/wiki/APA_style}}.
